...
Template.WidgetPackageRange.helpers({
	selectedDevice() {
...
Template.WidgetPackageRange.events({
	'click .js-add'(e, i) {
...
Template.WidgetPackageRange.onCreated(function () {
...
const WidgetPackageRangeSchema = new SimpleSchema({
  'title': {
    type: String
  },
  'device': {
...
Widgets.add({
  name: pluginName,
  template: 'WidgetPackageRange',
  group: 'chart',
  description: 'bla bla',
  image: '/chart.png',
  schema: WidgetPackageRangeSchema
})
